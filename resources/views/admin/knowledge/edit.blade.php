                    ...
                    <form method="post" class="needs-validation" novalidate action="{{ route('admin.knowledge.update', $knowledge->id) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <input type="text" placeholder="{{ __('Title of the Knowledge') }}" name="title_ar"
                                        ...
                                        value="{{ $knowledge->title_ar }}" required autofocus>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <input type="text" placeholder="{{ __('Title of the Knowledge') }}" name="title_en"
                                        ...
                                        value="{{ $knowledge->title_en }}" required autofocus>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="description_ar" id="description_ar" class="form-control summernote-simple {{(!empty($errors->first('description_ar')) ? 'is-invalid' : '')}}">{!! $knowledge->description_ar !!}</textarea>
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="description_en" id="description_en" class="form-control summernote-simple {{(!empty($errors->first('description_en')) ? 'is-invalid' : '')}}">{!! $knowledge->description_en !!}</textarea>
                                <div class="invalid-feedback">

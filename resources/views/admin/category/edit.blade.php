        ...
        <div class="form-group col-md-6">
            ...
            <div class="col-sm-12 col-md-12">
                <input type="text" placeholder="{{ __('Title Ar of the Category') }}" name="title_ar"
                    class="form-control {{ $errors->has('title_ar') ? ' is-invalid' : '' }}" required value="{{ $category->title_ar }}"
                    autofocus>
        ...
        <div class="form-group col-md-6">
            ...
            <div class="col-sm-12 col-md-12">
                <input type="text" placeholder="{{ __('Title En of the Category') }}" name="title_en"
                    class="form-control {{ $errors->has('title_en') ? ' is-invalid' : '' }}" required value="{{ $category->title_en }}"
                    autofocus>

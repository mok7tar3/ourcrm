                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            {{ Form::select('category', collect($categories)->mapWithKeys(fn($v,$k) => [$k => __($v)]), request('category'), ['class' => 'form-control select']) }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            {{ Form::select(
                                                'priority',
                                                collect($priorities)->mapWithKeys(fn($v,$k) => [$k => __($v)]),
                                                request('priority'),
                            ...
                            <tbody>
                                ...
                                {{-- @dd($tickets) --}}
                                    <tr>
                                        ...
                                        <td><span class="white-space">{{ $ticket->agent ? $ticket->agent->name : '-' }}</span></td>
                                        <td>{{ $ticket->agent ? $ticket->agent->email : '-' }}</td>
                                        <td>

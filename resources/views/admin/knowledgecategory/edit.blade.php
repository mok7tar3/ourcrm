                    ...
                    <form method="post" class="needs-validation" novalidate action="{{ route('admin.knowledgecategory.update', $knowledge_category->id) }}">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <input type="text" placeholder="{{ __('Title Ar of the Knowledge') }}" name="title_ar"
                                        ...
                                        value="{{ $knowledge_category->title_ar }}" required autofocus>
                            ...
                            <div class="form-group col-md-6">
                                <label class="form-label">{{ __('Title Ar') }}</label><x-required></x-required>
                                <div class="col-sm-12 col-md-12">
                                    <input type="text" placeholder="{{ __('Title Ar of the Knowledge') }}" name="title_en"
                                        class="form-control {{ $errors->has('title_en') ? ' is-invalid' : '' }}"
                                        value="{{ $knowledge_category->title_en }}" required autofocus>
                                    <div class="invalid-feedback">

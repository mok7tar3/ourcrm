                            ...
                            <div class="col-auto">
                                <div class="row">
                                    <div class="col-auto mt-4">
                                        <a href="#" class="btn btn-sm btn-primary me-2" onclick="document.getElementById('userlogin_filter').submit(); return false;" data-bs-toggle="tooltip" title="{{__('Apply')}}" data-original-title="{{__('apply')}}">
                                        ...
                                        <td>
                                            ...
                                            <div class="action-btn">
                                                <form method="POST" action="{{route('userlog.destroy',$user->id)}}" id="user-form-{{$user->id}}">
                                                    ...
                                                    <button type="submit" class="mx-3 btn btn-sm d-inline-flex align-items-center show_confirm bg-danger" data-toggle="tooltip"
                                                    title='Delete'>

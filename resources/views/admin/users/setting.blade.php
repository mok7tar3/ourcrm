                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="logo-content logo-set-bg  text-center py-2">
                                                        {{-- <a href="{{ asset(Storage::url('logo/logo-dark.png')) }}" target="_blank">hi
                                                    <img src="{{ storage_path('uploads/logo/logo-dark.png') }}" class="big-logo" id="blah2" alt="" />
                                                    </a> --}}
                                                        <a href="{{ isset($settings['logo']) ? asset($settings['logo']) : asset('logos/logos/dark-light.png') }}" target="_blank">
                                                            <img id="blah2" alt="your image"
                                                                src="{{ isset($settings['logo']) ? asset($settings['logo']) : asset('logos/logos/dark-light.png') }}"
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body setting-card setting-logo-box p-3">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="logo-content  logo-set-bg text-center py-2">
                                                        <a href="{{ isset($settings['white_logo']) ? asset($settings['white_logo']) : asset('logos/logos/logo-light.png') }}" target="_blank">
                                                            <img id="blah3" alt="your image"
                                                                src="{{ isset($settings['white_logo']) ? asset($settings['white_logo']) : asset('logos/logos/logo-light.png') }}"
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body setting-card setting-logo-box p-3">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="logo-content logo-set-bg text-center py-2">
                                                        <a href="{{ isset($settings['favicon']) ? asset($settings['favicon']) : asset('logos/logos/favicon.png') }}" target="_blank">
                                                            <img id="blah" alt="your image"
                                                                src="{{ isset($settings['favicon']) ? asset($settings['favicon']) : asset('logos/logos/favicon.png') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                        <label for="google_recaptcha_key"
                                            class="form-label">{{ __('Google Recaptcha Key') }}</label>
                                        <input required class="form-control" placeholder="{{ __('Enter Google Recaptcha Key') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            @php
                                                $src = isset($settings['meta_image']) && !empty($settings['meta_image']) ? asset('logos/logos/'.$settings['meta_image']) : asset('logos/logos/meta_image.png');
                                            @endphp

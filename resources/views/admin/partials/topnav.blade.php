                ...
                <li class="dropdown dash-h-item drp-company">
                    <a class="dash-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                        ...
                        <span class="theme-avtar">
                            <img src="{{(!empty(\Auth::user()->avatar))? ($logo.\Auth::user()->avatar): asset('logos/logos/avatar.png')}}" class="img-fluid rounded-circle"  class="header-avtar" width="50">
                        </span>
                    ...
                    <div class="dropdown-menu dash-h-dropdown">
                        ...
                        @if(session('is_sso'))
                            <a href="{{ route('logoutsso') }}" class="dropdown-item">
                                <i class="ti ti-power"></i>
                                <span>{{ __('Logout (SSO)') }}</span>
                            </a>
                        @else
                        ...
                        <!-- <form id="logout-form" action="{{ route('saml.logout') }}" method="POST" style="display: none;">
                            @csrf
                        </form> -->
                    </div>
                </li>
